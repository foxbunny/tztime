...
describe('TzTime.parse', function() {
  ...
  it('should parse AM/PM correctly', function() {
    var d;
  ...
  it('should ignore time zone if `utc` flag is set', function() {
    var d;
    d = TzTime.parse('2013-12-01 12:00 p.m.', '%Y-%m-%d %i:%M %p');
    equal(d.timezone, TzTime.platformZone);
    d = TzTime.parse('2013-12-01 12:00 p.m.', '%Y-%m-%d %i:%M %p', true);
    equal(d.timezone, 0);
    return equal(d.hours, 12);
  });
  it('should accept a timezone offset instead of utc flag', function() {
    var d;
    d = TzTime.parse('2013-12-01 12:00 p.m.', '%Y-%m-%d %i:%M %p');
    equal(d.timezone, TzTime.platformZone);
  ...
  it('should use default format if no format is supplied', function() {
    var d;
  ...
  return it('should use default format and UTC if no format is supplied', function() {
    var d;
